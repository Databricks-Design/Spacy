    ...
    for idx in range(max(len(df_without), len(df_with))):
        if idx >= len(df_without):
            ...
            comparison_data.append({
                ...
                id_col: row_id,
                desc_col: row_desc,
                'without_zone_output': "MISSING ROW",
                'with_zone_output': str(df_with.iloc[idx].get('outputs_ner', '')),
            ...
            comparison_data.append({
                ...
                id_col: row_id,
                desc_col: row_desc,
                'without_zone_output': str(df_without.iloc[idx].get('outputs_ner', '')),
                'with_zone_output': "MISSING ROW",
                'match_status': 'MISMATCH',
            ...
            comparison_data.append({
                ...
                desc_col: row_desc_without,
                'without_zone_output': json.dumps(output_without, ensure_ascii=False),
                'with_zone_output': json.dumps(output_with, ensure_ascii=False),
