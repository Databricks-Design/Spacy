...
# ADD THIS BLOCK (lines 17-30)
logger = logging.getLogger(__name__)

def setup_logger_for_test(log_file_path: str):
    """Configure logger to write to a specific file for each test"""
...
def main():
    ...
    setup_logger_for_test(os.path.join(OUTPUT_DIR, "without_zone.log"))  # ADD THIS LINE
    ...
    setup_logger_for_test(os.path.join(OUTPUT_DIR, "with_zone.log"))  # ADD THIS LINE
